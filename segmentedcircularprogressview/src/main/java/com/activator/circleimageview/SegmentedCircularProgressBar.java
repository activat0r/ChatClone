...
public class SegmentedCircularProgressBar extends ImageView {
    ...
    private static final int DEFAULT_UNREAD_COLOR = Color.GREEN;
    ...
    private static final float DEFAULT_GAP = 10f;
    ...
    private int mUnreadCount = 2;
    private int mReadCount = 2;
    ...
    public SegmentedCircularProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, com.activator.circleimageview.R.styleable.SegmentedCircularProgressBar, defStyle, 0);

        mBorderWidth = a.getDimensionPixelSize(com.activator.circleimageview.R.styleable.SegmentedCircularProgressBar_civ_border_width, DEFAULT_BORDER_WIDTH);
        mBorderColor = a.getColor(com.activator.circleimageview.R.styleable.SegmentedCircularProgressBar_civ_border_color, DEFAULT_BORDER_COLOR);
        mBorderOverlay = a.getBoolean(com.activator.circleimageview.R.styleable.SegmentedCircularProgressBar_civ_border_overlay, DEFAULT_BORDER_OVERLAY);
        mCircleBackgroundColor = a.getColor(com.activator.circleimageview.R.styleable.SegmentedCircularProgressBar_civ_circle_background_color, DEFAULT_CIRCLE_BACKGROUND_COLOR);
        mReadColor = a.getColor(com.activator.circleimageview.R.styleable.SegmentedCircularProgressBar_civ_read_progress_color,DEFAULT_READ_COLOR);
        mUnreadColor = a.getColor(com.activator.circleimageview.R.styleable.SegmentedCircularProgressBar_civ_unread_progress_color,DEFAULT_UNREAD_COLOR);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(mDrawProgressBar){
            ...
            if (mProgressBackgroundColor != Color.TRANSPARENT){
                arcPaint.setColor(mProgressBackgroundColor);
            ...
            for(int i = 0; i< mUnreadCount; i++){
                ...
                canvas.drawArc(rect,startRadii, arcRadii,false,arcPaint);
            }
        ...
        if (mBitmap != null) {
            if (mDrawableDirty && mBitmapCanvas != null) {
                ...
                drawable.setBounds((int) (mDrawableRect.left), (int) mDrawableRect.top, (int) (mDrawableRect.right), (int) (mDrawableRect.bottom));
            ...
            canvas.drawCircle(mDrawableRect.centerX()+mGap +mStrokeWidth, mDrawableRect.centerY()+mGap + mStrokeWidth, mDrawableRadius - (mGap ), mBitmapPaint);
    ...
    private RectF calculateBounds() {
        int availableWidth  = (int) (getWidth() - getPaddingLeft() - getPaddingRight() - (2*(mStrokeWidth + mGap)));
        int availableHeight =(int) (getHeight() - getPaddingTop() - getPaddingBottom() - (2*(mStrokeWidth + mGap)));
    ...
    private void updateShaderMatrix() {
        ...
        mShaderMatrix.postTranslate((int) (dx + 0.5f) + mDrawableRect.left + mStrokeWidth+mGap, (int) (dy + 0.5f) + mDrawableRect.top+ mStrokeWidth+mGap);
